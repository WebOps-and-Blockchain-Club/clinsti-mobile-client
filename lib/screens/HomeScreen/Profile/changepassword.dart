                            ...
                            children: [
                              ...
                              Material(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (val) {
                                    if(val.isEmpty) {
                                      setState(() {
                                        passError = "Please enter your current password";
                                      });
                                      return null;
                                    } else {
                                      setState(() {
                              ...
                              Material(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (val) {
                                    if(val.isEmpty) {
                                      setState(() {
                                        confirmPassError = "Please enter your Confirm Password";
                                      });
                                      return null;
                                    } else if(val != newPassword.text) {
                                      setState(() {
                                        confirmPassError = "Password must be same as above";
                                      });
                                      return null;
                                    } else {
                                      setState(() {
                              ...
                              Center(
                                child: ElevatedButton.icon(
                                  ...
                                  label: Text("Update Password", textScaleFactor: 1.2,)),
                              ),

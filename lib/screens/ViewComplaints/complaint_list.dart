...
class _ComplaintListState extends State<ComplaintList> {
  ...
  String filterBy = 'timeStamp';

  @override
  Widget build(BuildContext context) {
    if (filterBy == 'timeStamp') {
      setState(() {
        complaint.sort((b, a) => a.timestamp.compareTo(b.timestamp));
      });
    } else {
      setState(() {
        complaint.sort((b, a) => a.status.compareTo(b.status));
      });
    }
    return Column(
      children: <Widget>[
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              return ComplaintTile(complaint: complaint[i]);
            },
          ),
        ),
      ],
